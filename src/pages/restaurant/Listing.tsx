...
import RadioCategory from "../../components/restaurant/listings/RadioCategory.tsx";
import PriceRange from "../../components/restaurant/listings/PriceRange.tsx";
import Sort from "../../components/restaurant/listings/Sort.tsx";
import Hero from "../../components/restaurant/listings/Hero.tsx";
...
const Listings = () => {
    ...
    return (
        <div className="grid grid-cols-3 md:grid-cols-6 gap-6 mt-20">
            ...
            {/*    Right    */}
            <div className="col-span-5 flex-col px-4 py-6 md:px-10 lg:px-20">
                <Hero/>
                <div className="flex justify-between mt-8">
                    <h3 className="text-2xl font-semibold">123 Restaurants near you</h3>
                    <p className="px-3.5 bg-primary py-1 rounded-2xl self-start
